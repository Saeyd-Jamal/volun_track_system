<x-dashboard-layout>
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-6 nav-align-top">
                    <ul class="mb-4 nav nav-pills nav-fill" role="tablist">
                        <li class="mb-1 nav-item mb-sm-0">
                    ...
                    <form action="{{ route('dashboard.constants.store') }}" method="post">
                        ...
                        <div class="tab-content">
                            <div  class="tab-pane fade show active" role="tabpanel" id="menu1">
                                <h2 class="mt-4 h3">تحديد ملبغ السلفة حسب حالة الدوام للثبتين</h2>
                                <div class="row">
                                ...
                                <div class="mt-4 row justify-content-end align-items-center">
                                    <button type="submit" class="mx-2 btn btn-primary col-2">
                                        تعديل
                                    </button>
                                </div>
                            </div>
                            <div  class="tab-pane fade" role="tabpanel" id="menu2">
                                <h2 class="mt-4 h3">تحديد نسبة الخدمة</h2>
                                <div class="row">
                                    <div class="my-2 col-md-6">
                            ...
                            <div  class="tab-pane fade" role="tabpanel" id="menu3">
                                <h2 class="mt-4 h3">تحديد رواتب الصحة المثبتين</h2>
                                <div class="row">
                                    <div class="my-2 col-md-6">
