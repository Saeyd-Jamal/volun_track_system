    ...
    <div class="py-0 navbar-brand app-brand demo d-none d-xl-flex me-4" style="overflow: visible">
        <a href="{{ route('dashboard.home') }}" class="app-brand-link" style="overflow: visible;">
            <span class="app-brand-logo demo" style="overflow: visible">
                <img src=" {{ asset('imgs/favicon.ico') }}" alt="Logo" width="40">
            </span>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="p-0 nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ Storage::exists(Auth::user()->avatar_url) ? Auth::user()->avatar_url :asset('imgs/user.jpg') }}" alt class="rounded-circle" />
                    </div>
                </a>
                        ...
                        <a class="mt-0 dropdown-item" href="#">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                                    <div class="avatar avatar-online">
                                        <img src="{{ Storage::exists(Auth::user()->avatar_url) ? Storage::url(Auth::user()->avatar_url) :asset('imgs/user.jpg') }}" alt class="rounded-circle" />
                                    </div>
                                </div>
